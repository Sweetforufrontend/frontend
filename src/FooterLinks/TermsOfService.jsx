  ...
  return (
    <div className={css.contentdiv}>
      ...
      <p>
        ...
        <br></br>
        <br></br>
        This website is operated by sweet4u. Throughout the site, the terms
        “we”, “us” and “our” refer to sweet4u. sweet4u offers this website,
        ...
        conditions, policies and notices stated here. By visiting our site and/
        ...
        acceptance of those changes. Our store is hosted on Hostinger<br></br>
        <br></br>
        ...
        otherwise affect these Terms.<br></br>
        <br></br>
        <span>
        ...
        that it is your responsibility to monitor changes to our site.<br></br>
        <br></br>
        ...
        posted by you or any third-party.<br></br>
        <br></br>
        ...
        any related website for violating any of the prohibited uses.<br></br>
        <br></br>
        <span>
        ...
        shall sweet4u, our directors, officers, employees, affiliates, agents,
        ...
        <br></br>
        <br></br>
        You agree to indemnify, defend and hold harmless sweet4u and our parent,
        ...
        access to our Services (or any part thereof).<br></br>
        <br></br>
